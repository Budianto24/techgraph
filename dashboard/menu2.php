<!-- Sidebar -->
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
				...
				<li>
					<a href="slideshow"><span class="fa fa-picture-o"></span>&nbsp;&nbsp; SLIDESHOW</a>
				</li>
				<li>
					<a href="user"><span class="fa fa-users"></span>&nbsp;&nbsp; USERS</a>
				</li>
                <li>
        ...
        <!-- /#sidebar-wrapper -->
<div class="header">
	<div id="toggle"><a href="#menu-toggle" class="btn btn-default" id="menu-toggle"><span class="glyphicon glyphicon-menu-hamburger"></span></a></div>
		<div id="author">
			<div class="dropdown">
